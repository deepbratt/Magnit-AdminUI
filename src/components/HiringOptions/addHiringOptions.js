  ...
  const handleUpdate = async (id) => {
    ...
    await getOneHiringOptionsApi(id)
      .then((response) => {
        if (response.status === "success") {
          setValues({
            heading: response.data.hiringOptions.title,
            description: response.data.hiringOptions.description,
            buttonLabel: response.data.hiringOptions.buttonLabel,
            buttonLink: response.data.hiringOptions.buttonLink,
            id: id,
          });
        }
        if (response.status === "fail") {
