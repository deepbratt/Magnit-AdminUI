...
import { isResponseSuccess } from "../../Utils/helperFunctions.js";
...
const SeoText = () => {
  ...
  return (
    <Grid container>
        ...
        <Grid item xs={12}>
            <SeoTextForm itemId={itemId} clearItemId={()=>setItemId('')} setDataArray={setDataArray} dataArray={dataArray} setOpenToast={setOpenToast} setToastType={setToastType} setResponseMessage={setResponseMessage} setIsLoading={setIsLoading} />
        </Grid>
        <Grid item xs={12}>
            {/* table */}
            <DataTable
