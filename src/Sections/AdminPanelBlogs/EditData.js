...
export default function EditData({ id, edit }) {
  const { updateData, responseAlert,open,setOpen,toastType, headers } = useApi("https://api.themagnit.com/v1/blogs");
  ...
  const loadSelectedData = async () => {
    const result = await axios.get(`https://api.themagnit.com/v1/blogs/${id}`, {headers});
